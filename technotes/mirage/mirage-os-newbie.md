...
So far, so good! We are now ready to test our unikernel for “real”,
...
With this modifications one should expect to see something like the
...
Obviously, the former approach definitely requires less effort and
