...
profile='bkb.A_special24-v151001.1'
...
curl --ftp-ssl -k -T $tarfile "ftp://bkb:$password@ftp.auxdir.com/bkb/public/tars/env_pub/"
curl --ftp-ssl -k -T $tarfile_latest "ftp://bkb:$password@ftp.auxdir.com/bkb/public/tars/env_pub/"
