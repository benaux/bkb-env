...
$path='"/Users/bkb/Library/Application Support/Firefox/Profiles/hd1gqexl.default/places.sqlite"';
...
`ssh bkb\@thewindow "/cygdrive/c/cygwin/bin/cygstart.exe  microsoft-edge:$urlresult"`
